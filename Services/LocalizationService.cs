    ...
    private Dictionary<string, string>? LoadTranslation(string languageCode)
    {
        return languageCode switch
        {
            "en" => new Dictionary<string, string>
            {
                ...
                ["Info"] = "INFO",
                ["Version"] = "Version:",
                ["DevelopedWith"] = "Developed with .NET 8 and WinUI 3",
                ["Close"] = "Close",
            ...
            "de" => new Dictionary<string, string>
            {
                ...
                ["LastConnectedLabel"] = "Zuletzt:",
                ["NoDevicesFound"] = "Keine Geräte gefunden.\nKopple dein Handy in den Windows-Einstellungen.",
                ["Connect"] = "Verbinden",
                ["Disconnect"] = "Trennen",
                ["SetDefault"] = "Als Standardgerät festlegen",
                ["RemoveDefault"] = "Als Standardgerät entfernen",
                ...
                ["Info"] = "INFO",
                ["Version"] = "Version:",
                ["DevelopedWith"] = "Entwickelt mit .NET 8 und WinUI 3",
                ["Close"] = "Schließen",
            ...
            "zh" => new Dictionary<string, string>
            {
                ...
                ["Devices"] = "设备",
                ["Refresh"] = "刷新",
                ["LastConnectedLabel"] = "上次:",
                ["NoDevicesFound"] = "未找到设备。\n请在 Windows 设置中配对你的手机。",
                ["Connect"] = "连接",
                ["Disconnect"] = "断开",
                ["SetDefault"] = "设为默认设备",
                ["RemoveDefault"] = "取消默认设备",
                ["Settings"] = "设置",
                ["Help"] = "帮助与故障排除",
                ["Volume"] = "音量",
                ["Autostart"] = "开机启动",
                ...
                ["Info"] = "关于",
                ["Version"] = "版本：",
                ["DevelopedWith"] = "使用 .NET 8 和 WinUI 3 开发",
                ["Close"] = "关闭",
